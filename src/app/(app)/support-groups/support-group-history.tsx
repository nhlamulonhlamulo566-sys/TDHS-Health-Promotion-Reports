...
import { Users, Trash2, Loader2, User, Building } from "lucide-react";
...
export function SupportGroupHistory() {
  ...
  const handleDelete = async (id: string) => {
    ...
    toast({
        ...
        description: "The support group session has been removed.",
    });
  };
  ...
  const sessions = React.useMemo(() => {
    ...
    return activities
      .filter(a => {
          if (a.type !== 'Support Group') return false;
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>This Month's Support Group Sessions</CardTitle>
      </CardHeader>
      <CardContent>
        {isLoading ? (
                      ...
                      <div className="flex items-center gap-2">
                          ...
                          <AlertDialog>
                              ...
                              <AlertDialogContent>
                                  ...
                                  <AlertDialogDescription>
                                      This action cannot be undone. This will permanently delete this support group session.
                                  </AlertDialogDescription>
                                  </AlertDialogHeader>
                                  <AlertDialogFooter>
          ...
          <div className="flex flex-col h-40 items-center justify-center rounded-md border border-dashed text-center">
            <Users className="h-10 w-10 text-muted-foreground/50 mb-4" strokeWidth={1.5} />
            <p className="text-muted-foreground">
              No support group sessions recorded this month.
            </p>
          </div>
        )}
      </CardContent>
