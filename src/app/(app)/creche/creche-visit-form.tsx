...
import { CalendarIcon, PlusCircle, Save, Users, Building, Heart, Loader2, Clock } from "lucide-react";
...
type CrecheVisitFormValues = z.infer<typeof crecheVisitFormSchema>;
...
export function CrecheVisitForm() {
  ...
  const form = useForm<CrecheVisitFormValues>({
    resolver: zodResolver(crecheVisitFormSchema),
    defaultValues,
  });
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Creche Name *</FormLabel>
                    <FormControl>
                ...
                <FormItem>
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Mix Age Group">Mix Age Group</SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
                </FormItem>
            ...
            <Button type="submit" size="lg" className="w-full" disabled={isSubmitting}>
              ...
              {isSubmitting ? "Saving..." : "Save Creche Visit"}
            </Button>
          </form>
        </Form>
      </CardContent>
