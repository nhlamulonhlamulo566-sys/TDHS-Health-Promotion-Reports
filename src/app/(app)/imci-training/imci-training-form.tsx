...
const trainingFormSchema = z.object({
  ...
  pictureFile: z.any().optional(),
    ...
    message: "Please specify the 'Other' trainee type.",
    path: ["otherTraineeType"],
}).refine(data => {
...
export function ImciTrainingForm() {
  ...
  const watchTraineeType = form.watch("traineeType");
  const isOtherSelected = watchTraineeType === "Other";
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>Who Was Trained *</FormLabel>
                  <Select
                  ...
                  >
                    <FormControl>
                      <SelectTrigger>
                        <SelectValue placeholder="Select trainee type..." />
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
            ...
            {isOtherSelected && (
              <FormField
                control={form.control}
                name="otherTraineeType"
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Please specify other trainee type</FormLabel>
                    <FormControl>
                      <Input
                        placeholder="Enter other trainee type..."
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="Key points covered, feedback, challenges, etc..."
                      rows={4}
                      {...field}
                    />
                  </FormControl>
            ...
            <Button type="submit" size="lg" className="w-full" disabled={isSubmitting}>
              ...
              {isSubmitting ? "Saving..." : "Save IMCI Training"}
            </Button>
          </form>
        </Form>
      </CardContent>
