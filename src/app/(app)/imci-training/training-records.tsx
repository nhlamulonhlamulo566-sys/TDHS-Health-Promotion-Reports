        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            {trainings.map((training) => (
                <div key={training.id} className="flex items-start justify-between gap-4 rounded-lg p-4 hover:bg-secondary">
          ...
          <div className="flex flex-col h-60 items-center justify-center rounded-md border border-dashed text-center">
            ...
            <p className="text-muted-foreground">
              No IMCI trainings recorded yet
            </p>
          </div>
        )}
      </CardContent>
