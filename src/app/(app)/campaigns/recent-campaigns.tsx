...
import { HeartPulse, MapPin, Trash2, Loader2, User, Building } from "lucide-react";
...
export function RecentCampaigns() {
    ...
    const handleDelete = async (id: string) => {
        ...
        toast({
            ...
            description: "The health campaign has been removed.",
        });
    };
    ...
    const campaigns = React.useMemo(() => {
      ...
      return activities
        .filter(a => {
            if (a.type !== 'Health Campaign') return false;
      ...
      <CardContent>
        {isLoading ? (
                    ...
                    <React.Fragment key={campaign.id}>
                      <div className="flex items-start justify-between gap-4 rounded-lg p-4 hover:bg-secondary">
                          ...
                          <div className="flex items-center gap-2 text-sm text-muted-foreground">
                              ...
                              <span>{campaign.details.venue}</span>
                          </div>
                          {isAdministrator && (
                              <>
                                  {campaign.userName && (
          ...
          <div className="flex flex-col h-60 items-center justify-center rounded-md border border-dashed text-center">
            <HeartPulse className="h-10 w-10 text-muted-foreground/50 mb-4" strokeWidth={1.5} />
